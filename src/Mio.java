...
public class Mio {
    ...
    public static BufferedInputStream OpenRead(String s) {
        try { return new BufferedInputStream(new FileInputStream(new File(s))); }
        catch (IOException e) { System.err.println("Kan inte �ppna "+s); }
        return null;
    }
    ...
    public static String GetLine() { return GetLine(keyboard); }
    ...
    public static String GetWord() { return GetWord(keyboard); }
    ...
    public static int GetInt(BufferedInputStream in) {
        ...
        catch(NumberFormatException e) { System.err.println("Not an integer:"+word); }
        return 0;
    }

    /** L�s ett heltal avgr�nsat av blanka fr�n tangenterna och returnera det */
    public static int GetInt() { return GetInt(keyboard); }

    /** L�s ett doubletal avgr�nsat av blanka fr�n filen och returnera det */
    public static double GetReal(BufferedInputStream in) {
        String word=GetWord(in);
        try { return Double.valueOf(word); }
        catch(NumberFormatException e) { System.err.println("Not a number:"+word); }
        return 0;
    }
